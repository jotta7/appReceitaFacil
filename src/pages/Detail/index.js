...
import { isFavorite, saveFavorite, removeFavorites } from "../../utils/storage";
...
export default function Detail(){
  ...
  async function shareReceipe(){
    try{
      await Share.share({
        url: " https://jotta7.github.io/portfolio/", //source={{ uri: videoUrl}}
        message: `Receita: ${route.params?.data.name}\n Ingredientes: ${route.params?.data.total_ingredients}\n Vi lá no app Receita Fácil! https://jotta7.github.io/portfolio/`
      })
    }catch(error){
      console.log(error);
    }
